...
namespace ExemploRelatorio.Controllers
{
    public class PacienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PacienteId,NomePaciente")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PacienteId,NomePaciente")] Paciente paciente)
        {
